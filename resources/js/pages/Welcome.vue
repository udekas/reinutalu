    ...
    <div class="font-sans text-gray-800">
        ...
        <section class="py-16">
            <div class="container mx-auto px-4 text-center">
                ...
                <a :href="route('gallery')" class="bg-primary inline-block rounded-md px-6 py-2 text-white transition hover:bg-[#6d4a2a]"
                    >Vaata galeriid</a
                >
            </div>
        </section>
        ...
        <section class="bg-secondary">
            <div class="container mx-auto flex flex-col md:flex-row">
                <div class="flex flex-col justify-center p-12 md:w-1/2">
                    ...
                    <a :href="route('about')" class="bg-primary inline-block self-start rounded-md px-6 py-2 text-white transition hover:bg-[#6d4a2a]"
                        >Loe lähemalt</a
                    >
                </div>
